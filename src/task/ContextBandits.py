...
class ContextualBandit:
    ...
    def __init__(
        ...
        self.raw_barcodes = to_pth(np.asarray(self.raw_barcodes)).to(self.device)
        ...
        while new_seed_needed:
            ...
            for cluster in bc_clusters:
                ...
                if not new_seed_needed:
                    ...
                    for raw_bc in mini_cluster_bag:
                        self.raw_barcodes.append(np.fromstring(raw_bc, np.int8)-48)
